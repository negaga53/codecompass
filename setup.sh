...
echo -e "  codecompass --repo /path/to/repo onboard"
echo ""
echo -e "  ${CYAN}# Start interactive chat${NC}"
echo -e "  codecompass --repo /path/to/repo chat"
echo ""
echo -e "  ${CYAN}# Launch the full TUI${NC}"
echo -e "  codecompass --repo /path/to/repo tui"
echo ""
echo -e "  ${CYAN}# Ask a question about any codebase${NC}"
echo -e "  codecompass --repo /path/to/repo ask \"How does authentication work?\""
echo ""
echo -e "  ${CYAN}# Export onboarding docs${NC}"
echo -e "  codecompass --repo /path/to/repo export --format markdown -o onboarding.md"
echo ""
